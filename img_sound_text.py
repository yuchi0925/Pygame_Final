...
# final_window
score_img = pygame.transform.scale(pygame.image.load("img/score2.png"), (260, 130))

# pause_window
pause_img = pygame.transform.scale(pygame.image.load("img/pause.png"), (400, 200))



# load music
shoot_sound = pygame.mixer.Sound(os.path.join("sound", "shoot.wav"))
pow0_sound = pygame.mixer.Sound(os.path.join("sound", "pow0.wav"))
pow1_sound = pygame.mixer.Sound(os.path.join("sound", "pow1.wav"))
